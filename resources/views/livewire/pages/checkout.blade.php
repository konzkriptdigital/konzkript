<div class="flex flex-col flex-auto h-full overflow-hidden lg:flex-row bg-[#F8FAFC]">
    ...
    <div class="px-4 lg:order-2 lg:min-w-0 lg:flex-1 lg:px-16 xl:px-20">
        <div class="grid max-w-md grid-cols-1 mx-auto lg:mx-0 lg:max-w-lg">
            <div class="relative py-10 lg:pt-24">
                <div
                    class="absolute inset-y-0 left-1/2 -ml-[55vw] w-[110vw] bg-gradient-to-b from-white/100 shadow-slate-900/5 lg:hidden">
                </div>
                <div class="relative"><a href="/"><svg class="w-auto h-6 text-slate-900 lg:hidden"
                    ...
                    <div class="flex mt-10 space-x-3 lg:mt-0">
                        <h1 class="text-base font-semibold leading-6 text-sky-500">All-access</h1><span
                            class="px-3 text-xs font-semibold leading-6 rounded-full bg-slate-300/25 text-slate-500">Personal
                            license</span>
                    </div>
                    <div class="flex items-center mt-4 space-x-3">
                        <p class="text-4xl text-slate-900">$<span class="font-bold">2</span><span
                                class="font-bold">9</span><span class="font-bold">9</span></p>
                        <p class="text-sm font-semibold text-slate-500">one-time payment</p>
                    </div>
                    ...
                    <dl class="hidden mt-16 text-base leading-6 divide-y divide-slate-900/5 text-slate-700 lg:block">
                        <div class="flex justify-between pb-4">
                            ...
                            <dd class="font-semibold text-slate-900">
                                $<span>2</span><span>9</span><span>9</span>.<span>0</span><span>0</span></dd>
                        </div>
                        ...
                        <div class="flex justify-between pt-4 font-semibold text-slate-900">
                            <dt>Total price</dt>
                            <dd>$<span>2</span><span>9</span><span>9</span>.<span>0</span><span>0</span></dd>
                        </div>
                    </dl>
                </div>
            </div>
    ...
    <div
        class="border-l border-slate-200 relative w-full bg-white px-4 pb-28 pt-10 backdrop-blur lg:max-w-[34rem] lg:grow-0 lg:px-16 lg:shadow-2xl xl:px-20">
        <a href="/"><svg class="hidden w-auto h-6 text-slate-900 lg:block" aria-hidden="true" viewBox="0 0 160 24"
                fill="none">
                <path
                    d="M18.724 1.714c-4.538 0-7.376 2.286-8.51 6.857 1.702-2.285 3.687-3.143 5.957-2.57 1.296.325 2.22 1.271 3.245 2.318 1.668 1.706 3.6 3.681 7.819 3.681 4.539 0 7.376-2.286 8.51-6.857-1.701 2.286-3.687 3.143-5.957 2.571-1.294-.325-2.22-1.272-3.245-2.32-1.668-1.705-3.6-3.68-7.819-3.68zM10.214 12c-4.539 0-7.376 2.286-8.51 6.857 1.701-2.286 3.687-3.143 5.957-2.571 1.294.325 2.22 1.272 3.245 2.32 1.668 1.705 3.6 3.68 7.818 3.68 4.54 0 7.377-2.286 8.511-6.857-1.702 2.286-3.688 3.143-5.957 2.571-1.295-.326-2.22-1.272-3.245-2.32-1.669-1.705-3.6-3.68-7.82-3.68z"
                    class="fill-sky-400"></path>

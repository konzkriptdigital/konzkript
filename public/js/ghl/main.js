...
var KONZKRIPT_MAIN = {
  ...
  _agency: function _agency() {},
  _$router: function _$router() {
    var _this = this;
    KONZKRIPT_HELPER.v.$router.afterEach(function (to, from) {
      console.log(to, from);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
             ...
             * @returns {void}
             */
            KONZKRIPT_HELPER.setIframe("".concat(KONZKRIPT_HELPER.getScriptBaseUrl(), "/editor/").concat(KONZKRIPT_HELPER.getCompanyId()), 'konzkriptEditorIframe');
          ...
          case 13:
            if (!_this2.isInitialized) {
              ...
              _this2.isInitialized = !_this2.isInitialized;
            }
